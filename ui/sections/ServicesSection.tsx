              ...
              <BentoGridItem
                ...
                header={
                  <div className="flex flex-1 w-full h-full min-h-[8rem] md:min-h-[10rem] rounded-2xl md:rounded-3xl overflow-hidden relative group/image">
                    <img
                      src={service.image}
                      alt={`${service.title} - CARINE VTC`} className="w-full h-full object-cover transition-transform duration-700 group-hover/image:scale-110 grayscale group-hover/image:grayscale-0"
                    />
